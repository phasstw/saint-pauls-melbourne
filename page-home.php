...
<section class="home">
  <h2 class="section-heading">Sunday Morning</h2>

  <div class="service-times-bg">
    <div class="service-times">
      <h3>Sunday Service Times</h3>
      <p>7:00am - Morning Prayer - Matins</p>
      <p>8:00am - Low Mass (<span class="italic">said</span>)</p>
      <p>10:00am - High Mass (<span class="italic">sung</span>) with Incense*</p>
      <span id="footnote" class="italic">*Sunday School available for children younger than 5 years old</span>
    </div>
  </div>
  ...
  <a class="button smallcaps" href="#">view daily mass schedule</a>
